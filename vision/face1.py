...
class Student:
    def __init__(self, root):
        ...
        studentName_label = Label(class_Student_frame, text="Student Name:", font=("times new roman", 12, "bold"),
                                  fg="red")
        studentName_label.grid(row=0, column=2, padx=1, sticky=W)

        studentName_entry = ttk.Entry(class_Student_frame, textvariable=self.var_std_name, width=13,
                                      font=("times new roman", 12, "bold"))
        ...
        # =======SEARCH SYSTEM=======
        search_frame = LabelFrame(right_frame, relief=RIDGE, text="Search System ",
                                  font=("times new roman", 12, "bold"), fg="red")
